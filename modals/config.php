...
define('STRIPE_SUCCESS_URL', 'http://localhost/ADMINHUB-MASTER/user/success.php'); //Payment success URL 
define('STRIPE_CANCEL_URL', 'http://localhost/ADMINHUB-MASTER/user/cancel.php'); //Payment cancel URL 
